...
$hooks = array(
    array(
     ...
     array(
        'id' => 'displayFooterBottom',
        'name' => 'displayFooterBottom',
    ),
     array(
    ...
    array(
     ...
     array(
        'id' => 'displayCenterBottomProduct',
        'name' => 'displayCenterBottomProduct',
    ),   
     array(
     ...
     array(
        'id' => 'displayCenterTopProduct',
        'name' => 'displayCenterTopProduct',
    ),   
     array(
        'id' => 'displayTop',
        'name' => 'displayTop',
     ...
     array(
        'id' => 'displayhomemiddle',
        'name' => 'displayhomemiddle',
    ),   
     array(
